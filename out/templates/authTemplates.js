...
exports.getAuthContextTemplate = getAuthContextTemplate;
exports.getLoginPageTemplate = getLoginPageTemplate;
exports.getHomePageTemplate = getHomePageTemplate;
exports.getPrivateRouteTemplate = getPrivateRouteTemplate;
exports.getGoogleCallbackTemplate = getGoogleCallbackTemplate;
exports.getAppTemplate = getAppTemplate;
function getAuthContextTemplate(options) {
    return `
...
function getLoginPageTemplate(options) {
    const { theme } = options;
...
function getHomePageTemplate(options) {
    const { theme } = options;
    const isDark = theme === 'dark';
    const bgClass = isDark ? 'bg-gray-900' : 'bg-gray-50';
    const cardClass = isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200';
